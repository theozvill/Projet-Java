...
public class SacADos{
     ...
     * @throws IllegalArgumentException Si la dimension est inférieure à 1, si la taille du tableau des budgets ne correspond pas à la dimension, ou si les objets n'ont pas la bonne dimension.
     */
    ...
    /**
     * Calcule les coûts totaux du sac à dos pour chaque dimension.
     * 
     * @return un tableau contenant, pour chaque dimension, la somme des coûts des objets présents dans le sac à dos.
     */
    public int[] coutsTotaux(){
        int[] sommes = new int[this.dimension];
